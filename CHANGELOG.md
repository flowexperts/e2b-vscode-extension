...
- Resolved issue with terminal sessions not initializing correctly in certain environments
...
- Updated CLAUDE.md with latest project instructions
...
- Automated release process via version tags

### Changed
- Updated PUBLISHING.md with automated publishing instructions
...
[0.1.5]: https://github.com/flowexperts/e2b-vscode-extension/releases/tag/v0.1.5
[0.1.4]: https://github.com/flowexperts/e2b-vscode-extension/releases/tag/v0.1.4
[0.1.3]: https://github.com/flowexperts/e2b-vscode-extension/releases/tag/v0.1.3
[0.1.2]: https://github.com/flowexperts/e2b-vscode-extension/releases/tag/v0.1.2
[0.1.0]: https://github.com/flowexperts/e2b-vscode-extension/releases/tag/v0.1.0
